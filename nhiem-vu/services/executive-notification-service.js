...
import { EXECUTIVE_NOTIFICATION_WEB_APP_URL } from "../executive-notification-config.js?v=20260911.V1_23_1";
...
export const ExecutiveNotificationService = Object.freeze({
  ...
  async send(action, directiveId, eventData = {}, options = {}) {
    if (!NOTIFICATIONS_ENABLED) return { ok: true, status: "DISABLED", eventId: "" };
