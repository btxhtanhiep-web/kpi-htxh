...
export function buildKpiWorkbookBlob({
  ...
  const sheetRows = [];
  sheetRows.push(makeRow(1, [{ value: 'TRUNG TÂM HỖ TRỢ XÃ HỘI', style: 5 }, ...Array(10).fill({ value:'', style:5 })], { height: 23 }));
...
export function buildProductCatalogWorkbookBlob({
  ...
  row(2, [
    { value:'TRUNG TÂM HỖ TRỢ XÃ HỘI', style:5 }, { value:'',style:5 }, { value:'',style:5 }, { value:'',style:5 },
...
<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  ...
  const app = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>Nhiệm vụ và đánh giá KPI - Hỗ trợ xã hội</Application></Properties>`;
  const zip = zipStore([
...
export function buildDepartmentSummaryWorkbookBlob({
  ...
  spanning(1, 'TRUNG TÂM HỖ TRỢ XÃ HỘI', 5, 21);
