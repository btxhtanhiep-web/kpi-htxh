...
import { FirebaseService } from "./firebase-service.js?v=20260916.V1_24_7_HTXH_1";
...
async function readAccessAccount(firebaseUser, progress) {
  ...
  if (!accessSnapshot.exists()) {
    throw codedError("AUTH_ACCESS_NOT_FOUND", `Email ${email} chưa được cấp quyền sử dụng hệ thống. Vui lòng liên hệ Phòng Tổ chức - Kế toán.`);
  }
  const access = accessSnapshot.data() || {};
