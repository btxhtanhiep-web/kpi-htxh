...
import { TaskNotificationBridge } from "./services/task-notification-bridge.js?v=20260808.V1_10_1";
import {
  openTchcCouncilManager,
  openDepartmentCouncilManager,
  openMyCouncilAdjustments,
  openCouncilReport
} from "./modules/kpi/council-adjustment-ui.js?v=20260808.V1_10_1";

const BUILD = "20260808.V1_10_1";
let observer = null;
let scheduled = false;
...
function scheduleEnhance() {
  ...
  requestAnimationFrame(() => {
    scheduled = false;
    try { enhance(); } catch (error) { console.warn("V1.10.1 enhancement skipped:", error); }
  });
}
...
function bootstrap() {
  console.info("Nhiệm vụ & KPI release enhancement V1.10.1", BUILD);
  observer?.disconnect();
