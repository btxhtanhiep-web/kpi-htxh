...
import { DirectorTaskService } from "../../services/director-task-service.js?v=20260916.V1_24_7_HTXH_1";
...
import { validateTaskCreateInput, cleanTaskSentence } from "./task-form-validator.js?v=20260916.V1_24_7_HTXH_1";
import { mountTaskAiAssistant } from "../../ai-assistant.js?v=20260916.V1_24_7_HTXH_1";
...
export async function openTaskCreateModal({ onSaved }) {
  ...
  const directorAssignmentMode = Permissions.isDirector();
  const canChooseDepartment = directorAssignmentMode;
  const defaultDepartment = canChooseDepartment
    ? (current.departmentId || departments[0]?.id || departments[0]?.code || "TCKT")
