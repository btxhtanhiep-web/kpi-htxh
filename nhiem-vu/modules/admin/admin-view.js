...
import { AdminReadService } from "../../services/admin-read-service.js?v=20260916.V1_24_7_HTXH_1";
import { AdminMaintenanceService } from "../../services/admin-maintenance-service.js?v=20260916.V1_24_7_HTXH_1";
...
function render(outlet, user, diagnostic = null) {
  ...
  outlet.innerHTML = `<section class="page-card">
    <div class="page-header"><div><h2>Quản trị hệ thống</h2><p>Công cụ quản trị và bảo trì có kiểm soát.</p></div><span class="role-badge">ADMIN · V1.24.0</span></div>
