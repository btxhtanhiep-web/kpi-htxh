...
async function openTaskEditor(item) {
  ...
  const root = openStandardModal(
    ...
    `<div class="standard-task-editor-intro">
      ...
      <span>Mã được cấp theo từng Phòng/Khu và từng tính chất: thường xuyên dạng TCHC01; đột xuất dạng TCKT-DX01. Mã mới luôn tăng theo số lớn nhất hiện có; không quay lại 01 hoặc lấp khoảng trống.</span>
    </div>
