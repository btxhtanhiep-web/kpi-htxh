...
import { DashboardReadService } from "../../services/dashboard-read-service.js?v=20260916.V1_24_7_HTXH_1";
...
function formatRole(role){return ({ADMIN:"Quản trị viên",DIRECTOR:"Ban Giám đốc",DEPARTMENT_LEADER:"Trưởng/Phó phòng, khu",TCHC_COORDINATOR:"Điều phối Tổ chức - Kế toán",STAFF:"Viên chức"})[String(role||"").toUpperCase()] || role || "Người dùng";}
