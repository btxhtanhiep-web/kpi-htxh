...
test('V1.24.7 version marker, HTML, SW và import đồng nhất', () => {
  assert.match(read('core/app-version.js'),/APP_VERSION = "1\.24\.7-HTXH"/);
  assert.match(read('core/app-version.js'),/20260916\.V1_24_7_HTXH_1/);
  assert.match(read('index.html'),/release-v1\.24\.7\.js\?v=20260916\.V1_24_7_HTXH_1/);
  assert.match(read('index.html'),/appVersionLabel">V1\.24\.7/);
  assert.match(read('sw.js'),/BUILD_VERSION = "20260916\.V1_24_7_HTXH_1"/);
