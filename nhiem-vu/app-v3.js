...
import { Router } from "./core/router.js?v=20260916.V1_24_7_HTXH_1";
import { APP_VERSION_LABEL, BUILD_VERSION } from "./core/app-version.js?v=20260916.V1_24_7_HTXH_1";
import { AuthService } from "./core/auth-service.js?v=20260916.V1_24_7_HTXH_1";
...
const renderDashboardView = lazyRoute("./modules/dashboard/dashboard-view.js?v=20260916.V1_24_7_HTXH_1", "renderDashboardView");
const renderExecutiveDirectivesView = lazyRoute("./modules/executive-directives/executive-directives-view.js?v=20260916.V1_24_7_HTXH_1", "renderExecutiveDirectivesView");
const renderTasksView = lazyRoute("./modules/tasks/tasks-view.js?v=20260916.V1_24_7_HTXH_1", "renderTasksView");
const renderStandardTasksView = lazyRoute("./modules/standard-tasks/standard-tasks-view.js?v=20260916.V1_24_7_HTXH_1", "renderStandardTasksView");
const renderPeriodsView = lazyRoute("./modules/periods/periods-view.js?v=20260916.V1_24_7_HTXH_1", "renderPeriodsView");
const renderPlansView = lazyRoute("./modules/plans/plans-view.js?v=20260916.V1_24_7_HTXH_1", "renderPlansView");
const renderEvaluationsView = lazyRoute("./modules/evaluations/evaluations-view.js?v=20260916.V1_24_7_HTXH_1", "renderEvaluationsView");
const renderReportsView = lazyRoute("./modules/reports/reports-view.js?v=20260916.V1_24_7_HTXH_1", "renderReportsView");
const renderAdminView = lazyRoute("./modules/admin/admin-view.js?v=20260916.V1_24_7_HTXH_1", "renderAdminView");
...
function applyRouteBrand(route = window.location.hash || "#/dashboard") {
  ...
  if (subtitle) subtitle.textContent = "Trung tâm Hỗ trợ xã hội";
  document.body.classList.toggle("is-executive-route", executive);
  document.title = executive ? "Chỉ đạo điều hành - Hỗ trợ xã hội" : "Nhiệm vụ và đánh giá KPI";
}
...
function currentUserSubtitle(user) {
  const departments = {
    BGD: "Ban Giám đốc", TCKT: "Phòng Tổ chức - Kế toán", CTXH: "Phòng Công tác xã hội",
...
function formatRole(role) {
  return ({ ADMIN: "Quản trị viên", DIRECTOR: "Ban Giám đốc", DEPARTMENT_LEADER: "Trưởng/Phó phòng, khu", TCHC_COORDINATOR: "Điều phối Tổ chức - Kế toán", STAFF: "Viên chức" })[String(role || "").toUpperCase()] || role || "Người dùng";
}
